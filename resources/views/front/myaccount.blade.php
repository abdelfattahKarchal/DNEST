                        ...
                        <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                            <div class="tab-pane fade" id="account-orders" role="tabpanel"
                                ...
                                <div class="myaccount-orders">
                                    <h4 class="small-title mb-5">Mes commandes</h4>
                                    ...
                                    @else
                                        <div class="text-center" style="margin: 50px;">
                                            ...
                                            <h5 class="text-muted">Il semble que votre historique d'achat soit vide.</h5>
                                            <ul class="mt-3">
                            ...
                            <div class="tab-pane fade show active" id="account-details" role="tabpanel"
                                ...
                                <div class="myaccount-details">
                                    <h4 class="small-title mb-5">DÉTAILS DE MON COMPTE</h4>
                                    <form id="form-myaccount-details" action="#" class="hiraola-form" style="border: none; padding:0;">
                                        ...
                                        <div class="hiraola-form-inner">
                                            ...
                                            <div class="single-input single-input-half">
                                                <label for="lname">Nom <span style="color:red;">(*)</span></label>
                                                <input type="text" name="lname" id="lname"
                                                    value="{{ Auth::user()->lname }}">
                                            </div>
                                            <div class="single-input single-input-half">
                                                <label for="phone">Télèphone <span style="color:red;">(*)</span></label>
                                            ...
                                            <div class="single-input">
                                                <label for="address">Adresse personnel <span style="color:red;">(*)</span></label>
                                            ...
                                            <div class="col-12 ml-auto col-md-2 mt-4 mb-4 form-group">
                                                <button type="button" onclick="updateInformationAccount({{ Auth::user()->id }})" class="hiraola-login_btn" style="display: inline !important;">Modifier</button>
                                            </div>
