...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            ...
            <small>THE D-NEST ADMINISTRATION</small>
        </div>
        <div class="card">
            <div class="body">
    ...
    <script src="{{ asset('backoffice/plugins/jquery-validation/jquery.validate.js') }}"></script>
    <script src="{{ asset('backoffice/js/admin.js') }}"></script>
    <script src="{{ asset('backoffice/js/pages/examples/sign-in.js') }}"></script>
</body>
